...
from EBO_components.emotionalMotor_display.src.genericworker import *
from learnbot_dsl import path as emopath
...
class SpecificWorker(GenericWorker):
	def __init__(self, proxy_map):
		...
		self.face = Face()
		self.configEmotions = {}
		for path in os.listdir(os.path.join(emopath, "imgs/emotionConfig")):
			if os.path.splitext(path)[1] == ".json":
				with open(os.path.join(emopath, "imgs/emotionConfig", path), "r") as f:
	...
	def expressFear(self):
		...
		# self.display_proxy.setImageFromFile("/home/robocomp/learnbot/EBO_components/emotionalMotor/imgs/frameBuffer/miedo.fb")
	...
	def expressSurprise(self):
		...
		# self.display_proxy.setImageFromFile("/home/robocomp/learnbot/EBO_components/emotionalMotor/imgs/frameBuffer/sorpresa.fb")
	...
	def expressAnger(self):
		...
		# self.display_proxy.setImageFromFile("/home/robocomp/learnbot/EBO_components/emotionalMotor/imgs/frameBuffer/ira.fb")
	...
	def expressSadness(self):
		...
		# self.display_proxy.setImageFromFile("/home/robocomp/learnbot/EBO_components/emotionalMotor/imgs/frameBuffer/tristeza.fb")
	...
	def expressDisgust(self):
		...
		# self.display_proxy.setImageFromFile("/home/robocomp/learnbot/EBO_components/emotionalMotor/imgs/frameBuffer/asco.fb")
	...
	def expressJoy(self):
		...
		# self.display_proxy.setImageFromFile("/home/robocomp/learnbot/EBO_components/emotionalMotor/imgs/frameBuffer/alegria.fb")
	...
	def expressNeutral(self):
		...
		# self.display_proxy.setImageFromFile("/home/robocomp/learnbot/EBO_components/emotionalMotor/imgs/frameBuffer/SinEmocion2.fb")
