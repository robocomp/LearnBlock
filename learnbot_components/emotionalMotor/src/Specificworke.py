...
class SpecificWorker(GenericWorker):
	def __init__(self, proxy_map):
		...
		self.face = Face()
		self.configEmotions = {}
		for path in os.listdir("/home/pi/learnbot/components/emotionalmotor/JSON"):
			with open(os.path.join("/home/pi/learnbot/components/emotionalmotor/JSON", path), "r") as f:
