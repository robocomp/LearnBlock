...
class LearnBlock:
    ...
    def __init__(self):
        ...
        #READ FUNTIONS
        functions = parserConfigBlock("configFuntions")
        functions += parserConfigBlock("configControl")
        functions += parserConfigBlock("configPerceptual")
        functions += parserConfigBlock("configPropiopercetive")
        functions += parserConfigBlock("configOperators")
...
"""
            ...
            fh = open("learnbot-dsl/main_tmp.py","wr")
            fh.writelines(text)
            fh.close()
            try:
                execfile("learnbot-dsl/main_tmp.py",{})
