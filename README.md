...
If you want to install LearnBlock from sources, the following packages must be installed:
    ...
    sudo -H pip3 install apriltag requests pyunpack opencv-python-headless imutils six tensorflow dlib paramiko Pillow paho_mqtt PySide2 pyparsing qdarkstyle future
