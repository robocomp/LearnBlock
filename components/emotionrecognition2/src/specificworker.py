...
MODEL_FILE = '/home/robocomp/robocomp/components/learnbot/components/emotionrecognition2/assets/emotion_classifier.pb'
IMAGE_SIZE = 128
NUM_CHANNELS = 1
NUM_FL = 272
EMOTIONS=['Happy','Sad','Neutral','Angry','Surprised']

face_cascade = cv2.CascadeClassifier('/home/robocomp/robocomp/components/learnbot/components/emotionrecognition2/assets/haarcascade_frontalface_default.xml')
predictor = dlib.shape_predictor('/home/robocomp/robocomp/components/learnbot/components/emotionrecognition2/assets/shape_predictor_68_face_landmarks.dat')
