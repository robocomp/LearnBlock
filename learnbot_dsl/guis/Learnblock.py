...
#
# Created: Tue Aug 27 20:34:30 2019
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.express = QtWidgets.QWidget()
        self.express.setObjectName("express")
        self.verticalLayout_14 = QtWidgets.QVBoxLayout(self.express)
        self.verticalLayout_14.setObjectName("verticalLayout_14")
        self.tableExpress = QtWidgets.QTableWidget(self.express)
        ...
        self.verticalLayout_11 = QtWidgets.QVBoxLayout(self.move)
        self.verticalLayout_11.setObjectName("verticalLayout_11")
        self.tableMotor = QtWidgets.QTableWidget(self.move)
        ...
        self.verticalLayout_10 = QtWidgets.QVBoxLayout(self.sensors)
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.tablePerceptual = QtWidgets.QTableWidget(self.sensors)
        ...
        self.propioperceptive = QtWidgets.QWidget()
        self.propioperceptive.setObjectName("propioperceptive")
        self.verticalLayout_9 = QtWidgets.QVBoxLayout(self.propioperceptive)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.tablePropioperceptive = QtWidgets.QTableWidget(self.propioperceptive)
        ...
        self.verticalLayout_15 = QtWidgets.QVBoxLayout(self.others)
        self.verticalLayout_15.setObjectName("verticalLayout_15")
        self.tableOthers = QtWidgets.QTableWidget(self.others)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.functions.setTabText(self.functions.indexOf(self.express), QtWidgets.QApplication.translate("MainWindow", "Expressions", None, -1))
        self.functions.setTabText(self.functions.indexOf(self.move), QtWidgets.QApplication.translate("MainWindow", "Motor", None, -1))
        self.functions.setTabText(self.functions.indexOf(self.sensors), QtWidgets.QApplication.translate("MainWindow", "Perceptual", None, -1))
        self.functions.setTabText(self.functions.indexOf(self.propioperceptive), QtWidgets.QApplication.translate("MainWindow", "Proprioceptive", None, -1))
        ...
        self.functions.setTabText(self.functions.indexOf(self.others), QtWidgets.QApplication.translate("MainWindow", "Others", None, -1))
