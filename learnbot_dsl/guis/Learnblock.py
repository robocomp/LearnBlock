...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.splitter.addWidget(self.textCode)
        self.errorList = QtWidgets.QListWidget()
        self.splitter.addWidget(self.errorList)
        ...
        self.position = QtWidgets.QLabel(self.statusbar)
        self.statusbar.addWidget(self.position)
