...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.listVarcomboBox = QtGui.QComboBox(Dialog)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QtGui.QApplication.translate("Dialog", "Delete variable", None, QtGui.QApplication.UnicodeUTF8))
