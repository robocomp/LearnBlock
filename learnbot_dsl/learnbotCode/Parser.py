...
STRINGVAR = Group(SECTAB + identifier.setResultsName("name") + Suppress(eq) + ASSIGSTRING).setResultsName(
    "STRINGVAR")  # Solved error var =  0
...
def parserLearntBotCode(inputFile, outputFile, physicalRobot=False, RobotId="None"):
    # print "----------------------------------" + inputFile + "----------------------------------------------"
    try:
