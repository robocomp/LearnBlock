class setConfigurationDefault:
	...
	def setconfigSimulated(self,value,name):
		...
		file.write("Laser12Proxy = laser:tcp -h localhost -p " + value[10] + "\n")
		file.write("Laser22Proxy = laser:tcp -h localhost -p " + value[11] + "\n")
		file.write("Laser32Proxy = laser:tcp -h localhost -p " + value[12] + "\n")
		file.write("Laser42Proxy = laser:tcp -h localhost -p " + value[13] + "\n")
		file.write("Laser52Proxy = laser:tcp -h localhost -p " + value[14] + "\n")
		file.write("Laser62Proxy = laser:tcp -h localhost -p " + value[15] + "\n")
		file.write("Laser72Proxy = laser:tcp -h localhost -p " + value[16] + "\n")
